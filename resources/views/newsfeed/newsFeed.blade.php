  ...
  <div class="container-fluid" style="margin-top: 1.75rem;">
    <div class="main-body">
      ...
      <div class="row gutters-sm">
        ...
        <div class="offset-5 col-sm-11 col-md-6 h-100 mb-5 p-0 glass ">
          <a href="/create" style="text-decoration:none ">
            <div class="container">
              <div class="row">
                <div class="post col-12 ">
                  <h2 style="color:black">Create Post</h2>
        ...
        <div class="offset-5 col-sm-11 col-md-6 h-100 mb-3 p-2 glass ">
          ...
          <div class="container"> <!-- user info  -->
                  <div class="row" style="max-height :2.8rem;">
                    ...
                    <div class="post-info-div">
                      <h6 class="post-info"><a class="info-link w3-hover-text-dark-grey" href="/home">Abhishek</a> | <a class="info-link w3-hover-text-dark-grey" href="/home">Wall name 2</a></h6>
                    </div>
                  </div>
                </div> 
                <hr>
