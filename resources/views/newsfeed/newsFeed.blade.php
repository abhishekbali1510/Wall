                ...
                <div class="container p-2">
                  ...
                  <div class="row" style="max-height :2.8rem;">
                    ...
                    <div class="post-info-div">
                      <h6 class="post-info"><a class="info-link w3-hover-text-dark-grey" href="/home">{{$post->createdBy}}</a> | <a class="info-link w3-hover-text-dark-grey" href="/wall/{{$post->wallName}}">{{$post->wallName}}</a></h6>
                    </div>
                  </div>
                </div>
                <hr>
