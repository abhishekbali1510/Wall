    ...
    <div class="container mart-100" onclick="redirector()">
        <div class="main-body">
            ...
            <div class="row gutters-sm">
                                    ...
                                    <div class="row" style="max-height :2.8rem;">
                                        ...
                                        <div class="post-info-div">
                                            <h6 class="post-info"><a class="info-link w3-hover-text-dark-grey"
                                                    href="/user/{{$post->createdBy}}">{{$post->createdBy}}</a> |
                                                <a class="info-link w3-hover-text-dark-grey"
                ...
                <div class="card c-90 col-md-12 cmnts-div scroll glass" style="height:fit-content">
                    ...
                    <li class="cmnt-li">
                        <div class="container li-cont">
                            <!-- user info  -->
                            <div class="row mart-5">
                                <div class="cmnt-dp-div m-0">
