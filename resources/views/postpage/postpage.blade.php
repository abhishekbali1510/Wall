                  ...
                  <div class="container p-2">
                    ...
                    <div class="row" style="max-height :2.8rem;">
                      ...
                      <div class="own-info-div">
                        <h6 class="own-info"><a class="info-link w3-hover-text-dark-grey" href="/home">{{$post->createdBy}}</a> | <a class="info-link w3-hover-text-dark-grey" href="/home"> {{$post->wallName}} </a></h6>
              ...
              <li class="cmnt-li ">
                  ...
                  <div class="row">
                    ...
                    <div class="cmnt-info-div col-10">
                      <h6 class="cmnt-info"><a class="info-link w3-hover-text-dark-grey" href="/home">{{$post->createdBy}}</a></h6>
                      <br>
...
">
                    ...
                    <div class="cmnt-info-div col-10">
                      <h6 class="cmnt-info"><a class="info-link w3-hover-text-dark-grey" href="/home"> {{$comment->commentedBy}} </a></h6>
