            ...
            <div class="row gutters-sm">
                ...
                <div class="col-sm-12 col-lg-5">
                    <div class="col-12">
                                    ...
                                    <div class="container p-2">
                                        ...
                                        <div class="row" style="max-height :2.8rem;">
                                            ...
                                            <img src="{{ asset('storage/images/users/'.$post->createdBy) }}"
                                                alt=" " onerror="this.onerror=null; this.src='{{ asset('storage/images/users/download') }}'" class="own-dp">
                                            </div>
                        ...
                        <div class="card mt-3 cmnts-div scroll glass" style="height:fit-content">
                            ...
                            <li class="cmnt-li ">
                                <div class="container ">
                                    <!-- user info  -->
                                    <div class="row">
                                        <div class="cmnt-dp-div col-1 mt-2 ml-2">
                                       
                                            <img src="{{ asset('storage/images/users/'.$post->createdBy) }}"
                                                alt=" " onerror="this.onerror=null; this.src='{{ asset('storage/images/users/download') }}'" class="cmnt-dp" style="margin-left: -15px;">
                                        </div>
                           ...
                           <hr>
                            ...
                            <li class="cmnt-li ">
                                <div class="container ">
                                    <!-- user info  -->
                                    <div class="row">
                                        <div class="cmnt-dp-div col-1 ml-2">
                                            <img src="{{ asset('storage/images/users/'.$comment->commentedBy) }}"
                                                alt=" " onerror="this.onerror=null; this.src='{{ asset('storage/images/users/download') }}'" class="cmnt-dp" style="margin-left: -15px;
">
                                        </div>
                                        <div class="cmnt-info-div col-10">
                                            <h6 class="cmnt-info"><a class="info-link w3-hover-text-dark-grey"
                                                    href="/home"> {{$comment->commentedBy}} </a></h6>
